...
{
    private static readonly string ClipboardDataFormatName = typeof(Models.Condition).FullName;
    ...
    void Remove()
    {
        Application.Current.Dispatcher.Invoke(() => ConditionList.Remove(SelectedCondition));
    ...
    async Task Copy()
    {
        ...
        clipboardService.SetData(ClipboardDataFormatName, conditionText);
        Application.Current.Dispatcher.Invoke(PasteCommand.NotifyCanExecuteChanged);
    }
